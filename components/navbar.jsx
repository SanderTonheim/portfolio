...
export default function Navbar() {
  ...
  return (
    <>
      <nav className=" sticky left-0 top-0 z-20 mx-auto flex h-20 w-full max-w-7xl items-center  justify-between bg-[#010101] px-6 py-4 xl:px-0">
        {/* logo */}
        ...
        />
        <section
          className={`SLIDE-IN-CONTAINER absolute right-0 top-0 z-40 flex min-h-screen w-full flex-col bg-black  text-white duration-500 ease-in-out ${
