...
export default function Header() {
  return (
    <div className="w-full bg-gradient-to-t from-[#161616] to-black">
      <section className="CONTAINER  flex flex-col  pt-4 text-6xl text-white md:flex-row-reverse md:justify-between md:px-10 lg:mx-auto lg:w-full lg:max-w-4xl lg:self-center xl:max-w-6xl xl:flex-col xl:items-center ">
