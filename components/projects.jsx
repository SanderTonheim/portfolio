...
export default function Projects() {
  return (
    <section
      id="projects"
      className='CONTAINER bg-[url("../assets/bg.jpg")] px-10 py-20 bg-black bg-center bg-no-repeat'
    >
      <div className="CONTENT flex max-w-7xl flex-col gap-6   md:mx-auto md:items-center ">
